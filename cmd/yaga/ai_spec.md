# yaga.yaml schema cheat-sheet

Compact reference for the yaga admin panel generator. Top-level keys:
...
`yaga edit --prompt "…"` returns ONLY the changed sections of config as a
